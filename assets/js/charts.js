...
function chartSpec(ind, obs) {
  ...
  switch (ind.key) {
    ...
    case "EMOE": return { periods: P, lines: [{ name: "Confianza empresarial", values: col(0), color: G }, { name: "Var. mensual (puntos)", values: col(1).map((v) => v == null ? null : v), color: SEC, axis: "right" }], leftName: "Puntos", rightName: "Var. mensual", leftFmt: "num", rightFmt: "num" };
