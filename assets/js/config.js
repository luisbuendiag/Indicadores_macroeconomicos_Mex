...
export const KPICFG = {
  PIB: { valCol: 0, valFmt: "bill", varCol: 3, varFmt: "pct-frac", varLabel: "Var. anual", yoyCol: 2, yoyFmt: "pct-frac", yoyLabel: "Var. trimestral", noun: "PIB", art: "el", grupo: "growth", assess: "growth", ctx: " (a precios de 2018)", vw: "crecimiento anual", vg: "m", comp: "frente al mismo trimestre del año anterior", goodSign: 1 },
  PIBSEC: { derived: "total", valFmt: "num", varCol: 3, varFmt: "pct-frac", varLabel: "Var. trimestral (terciarias)", yoyCol: 4, yoyFmt: "pct-frac", yoyLabel: "Var. anual (terciarias)", noun: "PIB total por actividad económica", art: "el", grupo: "growth", assess: "growth", ctx: " (a precios de 2018)", vw: "variación trimestral en las actividades terciarias", vg: "f", comp: "frente al trimestre anterior", goodSign: 1 },
